...
const Index = () => {
  return (
    <>
      ...
      {/* Абсолютно зафиксированный логотип */}
      ...
      <div className="min-h-screen bg-[#020202] text-[#f0f0f0] flex flex-col">
        {/* Main Section без лишних отступов сверху */}
        <main className="relative z-10 flex-1 flex flex-col items-center justify-center px-4 pb-16 pt-8 max-w-7xl mx-auto w-full">
